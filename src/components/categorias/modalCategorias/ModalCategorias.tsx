...
<<<<<<< HEAD
                <div className="bg-teal-600 items-center justify-center m-20">
                    ...
                    <div className="flex flex-col items-center justify-center mt-4">
                        <h3>Oferecemos cursos super legais para voce ser um super profissional</h3>
            ...
            <div className="grid grid-cols-2 items-center justify-center bg-teal-600">
                <div className="bg-teal-400 items-center justify-center m-20">
                    <div className="flex flex-col items-center justify-center">
                        <h2 className="flex font-semibold text-4xl" >Cursos</h2>
                        <p className="m-4">COLOCAR ALGUM TEXTO LEGALZINHO</p>
                    </div>
