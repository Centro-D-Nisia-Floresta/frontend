...
export default function CardServico({ servico }: CardServicosProps) {
  ...
  return (
    <>
      <div>
        <div className="container flex flex-col w-80 gap-2 border border-fuchsia-700 rounded-md p-3">
          ...
          <div className="flex flex-col">
            <div className="flex ">
              <button className="flex items-center mt-1 mr-3" onClick={() => adicionarProduto(servico)}><Basket size={26} weight="light" /> Comprar</button>
