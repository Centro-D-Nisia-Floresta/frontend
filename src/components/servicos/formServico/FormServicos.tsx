          ...
          <form className="flex w-full max-w-2xl flex-col p-4" onSubmit={gerarNovaServico}>
            ...
            <div className="flex flex-col">
              <div className="flex">
                ...
                <button type="submit" className="flex justify-center rounded-lg py-2 mt-5 border border-fuchsia-700 hover:bg-fuchsia-700 w-full hover:text-white" disabled={carregandoCategoria || isLoading}>
