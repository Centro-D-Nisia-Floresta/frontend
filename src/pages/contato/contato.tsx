        ...
        <>
            <div className="grid grid-cols-2 mb-10">
                <div className="flex flex-col justify-center items-center">
                    <h2 className="text-4xl font-medium p-2 mb-4">Nisía Floresta</h2>
                    <p className="mb-5 text-lg">Educação de qualidade para um futuro brilhante!</p>
                    <p className="text-md font-medium flex gap-2"><EnvelopeSimple size={26} weight="light" />cdnisiafloresta@gmail.com</p>
                </div>

                <div className="flex flex-col items-center bg">
                    <h2 className="mb-3 text-3xl font-medium p-2">Contate-nos</h2>
                    <form className="flex flex-col p-3 border rounded-md bg-white shadow-lg">
                        ...
                        <textarea name="mensagem" placeholder="Digite sua mensagem ..." className="p-2 border border-gray-300 rounded-md w-80" />
