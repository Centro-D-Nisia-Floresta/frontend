          ...
          <div className=" flex justify-center pb-10">
            <div className="container grid grid-cols-2 text-white">
              <div className="flex flex-col items-center gap-4 justify-center py-4">
                ...
                <Link to="/servicos"><button className='font-bold rounded px-4 py-2 bg-fuchsia-900 text- hover:bg-bright-turquoise-100 text-xl hover:text-fuchsia-800 hover:duration-500'>Ver mais</button></Link>
              </div>
